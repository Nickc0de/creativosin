<div  class="uk-container uk-padding" >
    <h2 class="uk-heading-small uk-heading-line cinn-title-section cinn-text-blue"><span>Entrevista con los emprendedores</span></h2>
    <div class="uk-child-width-1-3 uk-grid-medium uk-grid-match" uk-grid>
        <div>
            <div class="uk-card uk-card-default">
                <div class="uk-card-media-top uk-inline-clip uk-transition-toggle uk-height-small" tabindex="0">
                    <img class="uk-transition-scale-up uk-transition-opaque" src="images/blog1.jpg" alt="">
                </div>
        ...
        <div>
            <div class="uk-card uk-card-default">
                <div class="uk-card-media-top uk-inline-clip uk-transition-toggle uk-height-small" tabindex="0">
                    <img class="uk-transition-scale-up uk-transition-opaque" src="images/blog2.jpg" alt="">
                </div>
                <div class="uk-card-body uk-padding-small uk-position-relative">
                    <!-- <div class="uk-card-badge uk-label cinn-bg-orange uk-position-top-left cinn-badge-left">Entrevista</div> -->
                    <article class="uk-article">
        ...
        <div>
            <div class="uk-card uk-card-default">
                <div class="uk-card-media-top uk-inline-clip uk-transition-toggle uk-height-small" tabindex="0">
                    <img class="uk-transition-scale-up uk-transition-opaque" src="images/blog3.jpg" alt="">
                </div>
                <div class="uk-card-body uk-padding-small uk-position-relative">
                    <!-- <div class="uk-card-badge uk-label cinn-bg-orange uk-position-top-left cinn-badge-left">Entrevista</div> -->
                    <article class="uk-article">
